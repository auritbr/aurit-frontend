  ...
  return (
    ...
    >
      <button
        ...
        className={`inline-flex items-center gap-1.5 rounded px-2 py-1 uppercase tracking-wider transition-colors hover:bg-muted hover:text-foreground ${
          align === "right" ? "ml-auto text-right" : "-ml-2 text-left"
        }`}
